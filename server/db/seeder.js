...
function generator(writer, encoding, callback) {
  ...
  function write() {
    ...
    do {
      i -= 1;
      id += 1;
      const data = `${id}, ${Math.ceil(Math.random() * 8)}, ${Math.ceil(Math.random() * 5)}, ${faker.random.boolean()}, "${faker.internet.email()}", ${Math.floor(Math.random() * 10000000)}, ${Math.ceil(Math.random() * 5)}, ${Math.ceil(Math.random() * 4)}, ${Math.ceil(Math.random() * 5)}, ${Math.floor(Math.random() * 101)}, "${faker.address.city() + ' ' + faker.address.state()}", ${faker.internet.userName()}, ${Math.ceil(Math.random() * 5)}, ${Math.ceil(Math.random() * 5)}, ${faker.random.boolean()}, ${faker.random.boolean()}, ${faker.random.boolean()}, ${Math.ceil(Math.random() * 10)}, "${faker.lorem.paragraph()}", "${faker.date.recent(90).toString()}", "${faker.name.firstName() + ' ' + faker.name.lastName()}", ${Math.floor(Math.random() * 101)}\n`;
